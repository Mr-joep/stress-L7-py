...
def run_requests(max_threads):
    ...
    try:
        with concurrent.futures.ThreadPoolExecutor(max_threads) as executor:
            while True:
                futures = [executor.submit(make_request, DOMAIN_URL) for _ in range(1000)]  # Adjust the batch size as needed
